...
LOG_FILE="/home/roberto/ansible-proxmox/logs/update-proxmox-$DATE.log"  # Nový logový súbor s dátumom a časom
GOTIFY_URL="http://10.20.40.32:80"
APP_TOKEN="AeKqufT-RyQo_HL"  # API token z vašej Gotify aplikácie
TITLE="Ansible Proxmox Update Logs"

# Spustenie Ansible playbooku a zaznamenanie výstupu do logu
/usr/bin/ansible-playbook -i /home/roberto/ansible-proxmox/hosts /home/roberto/ansible-proxmox/update-proxmox.yaml >> $LOG_FILE 2>&1
